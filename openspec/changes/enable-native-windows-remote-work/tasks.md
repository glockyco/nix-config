...
- [ ] 5.2 Coordinate a source on a different physical network and exercise saved-name SSH, RDP, and file access. SSH and SFTP pass from the Pro on a separate network through a relayed path; RDP remains outstanding with task 4.3. Record actual results without introducing router port forwarding.
