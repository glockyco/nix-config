...
- [x] 1.1 Register `nix-config` with a complete flake update command and `flake.lock` allowlist
...
- [x] 2.2 Update the canonical runbook and dependency ownership guidance
...
- [x] 3.1 Run formatting, flake checks, system build, and strict OpenSpec validation
