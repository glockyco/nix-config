...
- [x] 4.4 After both host acceptance gates pass, remove the temporary Korolev launcher and obsolete default routing without deleting developer checkout or installer-owned data; verify fresh shells resolve only the supported wrapper and retain the previous working generations.
