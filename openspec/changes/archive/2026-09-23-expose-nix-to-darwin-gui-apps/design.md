...
**Goals:** Save one host-owned user-domain lookup path for future sessions. Verify an explicit-PATH Fork launch in this session. Preserve pinned project tools inside each repository's development shell.
