...
- [x] 2.4 Run a real native Darwin update through the candidate wrapper; record Homebrew delegation, initial and final versions, and successful `verify-personal-omp` output.

- [x] 2.5 Run the native Darwin wrapped-session smoke and exact personal commit preview; record the immutable plugin path, active policy, and unchanged disposable repository.
