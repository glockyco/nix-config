...
| Activated OMP workflow                          | Ordinary use and language acceptance passed on both hosts under the nonblocking startup contract. Linux initial semantic responses remain incomplete           | [Prebuilt acceptance](../../openspec/changes/use-prebuilt-language-server-artifacts/tasks.md)                  |
