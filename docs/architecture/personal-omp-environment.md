...
| Restart and isolation checks                    | Post-restart resolver ownership, public DNS, MagicDNS, and SSH passed. Employer-specific DNS and live LAN/inbound rejection remain unverified                  | [Tailnet tasks](../../openspec/changes/connect-fleet-over-tailnet/tasks.md)                                    |
