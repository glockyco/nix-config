...
| Activated OMP workflow                          | Ordinary read/edit/format/restore passed on both hosts. Real HotRepl C# requests: Darwin 7/7, Linux 5/7. Linux initial diagnostics and definition failed       | [Prebuilt acceptance](../../openspec/changes/use-prebuilt-language-server-artifacts/tasks.md)                  |
...
| Restart and isolation checks                    | Restart acceptance passed; employer-internal DNS is not applicable. Live LAN/inbound rejection remains unverified                                              | [Tailnet tasks](../../openspec/changes/connect-fleet-over-tailnet/tasks.md)                                    |
...
| Tailscale reliability | Restart verification is complete: resolver ownership, public DNS, MagicDNS, connectivity, and SSH passed. Employer-internal DNS is not applicable                                       | Record actual post-restart results. Retain the live LAN/inbound rejection gate without weakening isolation                                                    |
